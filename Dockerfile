FROM debian:sid
RUN apt update
RUN apt install -y vim bash xfce4-terminal xfld-desktop aqemu sudo curl wget aria2 qemu-system-x86 htop chromium screen tigervnc-standalone-server python3-pip python3-websockify python3 git fuse libfuse2 xdotool
